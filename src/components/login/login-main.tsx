    ...
    <main className='grid lg:grid-cols-[1fr,45vw]'>
      <div className='relative hidden items-center justify-center  lg:flex'>
        <NextImage
          ...
          src='/rio-de-janeiro-at-night-pictures-wallpaper-wallpaper-preview.jpg'
          alt='VOX Banner'
          layout='fill'
          useSkeleton
        />
        <i className='absolute'>
          <NextImage
            imgClassName='h-96 w-96'
            src='/letter-v-512.png'
            alt='V Social logo'
            width={384}
            height={384}
            useSkeleton
      ...
      <div className='flex flex-col items-center justify-between gap-6 p-8 lg:items-start lg:justify-center'>
        <i className='mb-0 self-center lg:mb-10 lg:self-auto'>
          <NextImage
            imgClassName='-mt-4 h-6 w-6 lg:h-12 lg:w-12'
            src='/assets/v-avatar.png'
            alt='VoX Social logo'
            width={48}
            height={48}
            useSkeleton
